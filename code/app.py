...
# # -------------------------------
# # Helper for creating styled cards
# # -------------------------------
# def create_input_card(label, component):
#     return dbc.Card(
#         dbc.CardBody([
#             html.H6(label, className="text-white text-center mb-2"),
#             component
#         ]),
#         style={
#             "marginBottom": "20px",
...
#     "Select Car Brand",
#     dcc.Dropdown(id="brand3", options=[{"label": b, "value": b} for b in brand_cats],
#                  value=default_values["brand"], style={"color": "black"})
# )
...
#                  value=default_values["year"], style={"color": "black"})
# )

# card_fuel = create_input_card(
#     "Select Fuel Type",
#     dcc.Dropdown(id="fuel3", options=[{"label": f, "value": f} for f in fuel_cat],
#                  value=default_values["fuel"], style={"color": "black"})
# )

# card_power = create_input_card(
#     "Maximum Power (bhp)",
#     dcc.Input(id="max_power3", type="number", value=default_values["max_power"],
#               style={"width": "100%", "color": "black"})
# )

# card_mileage = create_input_card(
#     "Mileage (km/l)",
#     dcc.Input(id="mileage3", type="number", value=default_values["mileage"],
#               style={"width": "100%", "color": "black"})
# )
...
#     dbc.CardBody([
#         html.H3("Prediction Result", className="text-center text-white mb-4"),

#         html.H5("Predicted Price Class:", className="text-white text-center"),
#         html.H2(" ", id="predicted_class",
#                 className="text-center fw-bold",
#                 style={"color": "#00FFAA"}),

#         html.Hr(),

#         html.H5("Raw Model Output:", className="text-white text-center mt-3"),
#         html.H2(" ", id="raw_prediction",
#                 className="text-center fw-bold",
#                 style={"color": "#FF5733"})
#     ]),
#     style={
...
#             style={"text-align": "center", "color": "#00FFAA", "marginBottom": "10px"}),

#     html.H5("Predict car prices based on features",
#             style={"text-align": "center", "color": "white", "marginBottom": "30px"}),
...
#             dbc.Card(
#                 dbc.CardBody([
#                     html.H4("Car Features", className="text-center text-white mb-4"),
...
#                     html.Br(),
#                     dbc.Button("Calculate Selling Price", id="submit3",
#                                color="success", className="w-100 mb-2"),
#                     dbc.Button("Clear", id="clear3",
#                                color="danger", className="w-100")
#                 ]),
#                 style={"backgroundColor": "#121212", "borderRadius": "12px", "padding": "15px"}
#             ),
#             md=5
#         ),

#         # Right panel: Prediction result
#         dbc.Col(card_predicted_price, md=7)
#     ], justify="center", align="start", style={"marginTop": "20px"}),

#     html.Hr(),

#     html.P("Tip: Adjust inputs and compare predictions. Categories: Cheap, Average, Expensive, Very Expensive.",
#            className="text-center text-muted")
# ], fluid=True)

# # -------------------------------
# # Combined callback for Calculate & Clear
# # -------------------------------
# @callback(
